<?php /* Smarty version 3.1.24, created on 2015-09-02 16:55:50
         compiled from "templates/default/chanlianggongxu.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:2393655e6b996c20e74_34137936%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dbeeb3e9b721cafa6e62bad7c4a9dfef12c9b33c' => 
    array (
      0 => 'templates/default/chanlianggongxu.tpl',
      1 => 1438083719,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2393655e6b996c20e74_34137936',
  'variables' => 
  array (
    'tableName' => 0,
    'chanlianggongxu' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_55e6b996cf7c28_70500289',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_55e6b996cf7c28_70500289')) {
function content_55e6b996cf7c28_70500289 ($_smarty_tpl) {
if (!is_callable('smarty_function_cycle')) require_once 'D:/Apache24/htdocs/rm/libs/plugins/function.cycle.php';

$_smarty_tpl->properties['nocache_hash'] = '2393655e6b996c20e74_34137936';
...
</h2><a href="index.php?p=chanlianggongxushuru">工序输入</a></caption> 
                <tr> 
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['record']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['chanlianggongxu']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
">
                        <td><?php echo $_smarty_tpl->tpl_vars['chanlianggongxu']->value[$_smarty_tpl->getVariable('smarty')->value['section']['record']['index']]['gongxuID'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['chanlianggongxu']->value[$_smarty_tpl->getVariable('smarty')->value['section']['record']['index']]['gongchang'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['chanlianggongxu']->value[$_smarty_tpl->getVariable('smarty')->value['section']['record']['index']]['chejian'];?>
</td>	
                        <td><?php echo $_smarty_tpl->tpl_vars['chanlianggongxu']->value[$_smarty_tpl->getVariable('smarty')->value['section']['record']['index']]['gongxu'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['chanlianggongxu']->value[$_smarty_tpl->getVariable('smarty')->value['section']['record']['index']]['gongjia'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['chanlianggongxu']->value[$_smarty_tpl->getVariable('smarty')->value['section']['record']['index']]['beizhu'];?>
</td>
                        
                      
                        
		        <td><a href="index.php?p=chanlianggongxumodify&gxID=<?php echo $_smarty_tpl->tpl_vars['chanlianggongxu']->value[$_smarty_tpl->getVariable('smarty')->value['section']['record']['index']]['gongxuID'];?>
">修改</a>
                            <a href="index.php?p=chanlianggongxudelete&gxID=<?php echo $_smarty_tpl->tpl_vars['chanlianggongxu']->value[$_smarty_tpl->getVariable('smarty')->value['section']['record']['index']]['gongxuID'];?>
">删除</a> </td>
