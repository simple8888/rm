...
$check_query = $mysqli->query("select userid from user where username='$username' and password='$password' limit 1");  
if($result = $check_query->fetch_array()){  
    ...
    //exit; 
    header("Location:index.php?p=main");exit;
   ...
   //else{ header("location:index.php");exit;}
    ...
    exit;   
     ...
     $tpl->assign("title","请登录");
     $tpl->display("default/login.tpl"); 
