...
<style>
.li{literal}{list-style-type:none;margin:15px;float:left;}{/literal}
</style>
<head>
<body>
   ...
   <div style="margin-top:35px;">
     <ul style="display:block;">
         <li class = "li"><a href="index.php?p=chanlianggongxu">产量工资之工序表</a></li>
         <li class = "li"><a href="index.php?p=chanliangzhouqi">盘点周期表</a></li>
      </ul>
    </div>
