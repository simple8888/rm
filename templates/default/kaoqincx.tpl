...
<table class="table" style="margin-top:20px;">
		...
		{section name=record loop=$kaoqin}
		    <tr bgcolor="{cycle values="#DDFFCC,#cafab1"}">
                        ...
                        <td><a href="kaoqinshuru.php?ygID={$kaoqin[record].yuangongID}&kqID={$kaoqin[record].kaoqinID}">插入</a>
		            <a href="kaoqinmodify.php?ygID={$kaoqin[record].yuangongID}&kqID={$kaoqin[record].kaoqinID}">修改</a>
                            <a href="kaoqindelete.php?ygID={$kaoqin[record].yuangongID}&kqID={$kaoqin[record].kaoqinID}">删除</a> </td>
