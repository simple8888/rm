...
<table class="table">
		...
		{section name=record loop=$yuangong}
		    <tr bgcolor="{cycle values="#DDFFCC,#cafab1"}">
                        ...
                        <td><a href="index.php?p=renlimodify&ygID={$yuangong[record].yuangongID}">修改</a>
		            <a href="index.php?p=renlidelete&ygID={$yuangong[record].yuangongID}">删除</a></td>
